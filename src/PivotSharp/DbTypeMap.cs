...
namespace PivotSharp
{
	public static class DbTypeMap
	{
		...
		public static DbType DbTypeFor(Type t) {
			return typeMap.Single(map => map.Type == t).DbType;
		}

		public static Type TypeFor(DbType t) {
			return typeMap.Any(map => map.DbType == t && map.IsRequired)
		...
		private static DbTypeMapping Map(Type type, DbType dbType, string dbTypeName, bool IsRequired) {
